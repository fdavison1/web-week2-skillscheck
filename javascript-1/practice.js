...
const me = {
	...
	state: 'utah', 
	age: 33,
	greeter: function greeter(){ return `Hello! My name is ${firstName} and I live in ${state}`},
}
//////////////////PROBLEM 12////////////////////
...
// Code Here
const total = myNumbers.reduce((acc, el) => acc + el, 0)
//////////////////PROBLEM 17////////////////////
...
// Code Here
myNumbersIndex = []
const myNumbersIndex2 = myNumbers.forEach(function(el, i){
